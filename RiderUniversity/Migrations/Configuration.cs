...
using RiderUniversity.DAL;
using RiderUniversity.Models;

namespace RiderUniversity.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RiderUniversity.DAL.SchoolContext>
    {
        ...
        protected override void Seed(RiderUniversity.DAL.SchoolContext context)
        {
